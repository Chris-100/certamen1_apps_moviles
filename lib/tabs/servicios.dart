import 'package:certamen1_apps_moviles/pages/contratos.dart';
  ...
  Widget build(BuildContext context) {
    return Center(
      child: ListView(
        children: [
          ListTile(
            leading: Icon(MdiIcons.bullet), iconColor:  Color.fromARGB(255, 125, 0, 0),
          ...
          ListTile(
            leading: Icon(MdiIcons.doctor), iconColor: Color.fromARGB(255, 125, 0, 0),
            trailing: Icon(Icons.keyboard_arrow_right),
          ...
          ListTile(
            leading: Icon(MdiIcons.shield), iconColor: Color.fromARGB(255, 125, 0, 0),
            trailing: Icon(Icons.keyboard_arrow_right),
          ...
          ListTile(
            leading: Icon(Icons.cleaning_services), iconColor: Color.fromARGB(255, 125, 0, 0),
            trailing: Icon(Icons.keyboard_arrow_right),
          ...
          ListTile(
            leading: Icon(Icons.hotel_class_outlined), iconColor: Color.fromARGB(255, 125, 0, 0),
            trailing: Icon(Icons.keyboard_arrow_right),
          ...
          ListTile(
            leading: Icon(MdiIcons.knife), iconColor: Color.fromARGB(255, 125, 0, 0),
            trailing: Icon(Icons.keyboard_arrow_right),
            title: Text('Contratos', style: TextStyle(color: Colors.white)),
            onTap: (){
              final route = MaterialPageRoute(builder: (context){
