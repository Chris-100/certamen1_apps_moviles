  ...
  Widget build(BuildContext context) {
    return Center(child: DefaultTabController(
      ...
      appBar: (AppBar(
        ...
        leading: Icon(MdiIcons.skullCrossbones, color:Color.fromARGB(255, 125, 0, 0)),
        ...
        bottom: TabBar(
          ...
          tabs: [
          Tab(text: 'Perfil',
          icon: Icon(Icons.account_circle, color: Color.fromARGB(255, 125, 0, 0)),),
          Tab(text: 'Servicios',
          icon: Icon(Icons.room_service, color: Color.fromARGB(255, 125, 0, 0),),),
        ],),
        )
      ),
